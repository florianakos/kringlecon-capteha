...
def predict_image(q, sess, graph, image_bytes, image_uuid, labels, input_operation, output_operation):
    ...
    q.put( {'image_uuid':image_uuid, 'prediction':labels[prediction].title(), 'percent':results[prediction]} )
...
def main():
    yourREALemailAddress = "flrnks@onbox.hu"
    ...
    final_answer = ','.join( predicted_uuids )
